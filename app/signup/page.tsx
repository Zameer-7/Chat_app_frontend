            ...
            <div style={styles.card}>
                ...
                <form onSubmit={handleSubmit} style={styles.form}>
                    <div style={styles.field}>
                        <label style={styles.label}>Username (Unique ID)</label>
                    ...
                    <div style={styles.field}>
                        <label style={styles.label}>Nickname (Display Name)</label>
                        <div style={styles.inputWrap}>
...
const styles: Record<string, React.CSSProperties> = {
    ...
    footer: { textAlign: "center", marginTop: "2rem", fontSize: "0.9rem", color: "#9ca3af" },
